  ...
  return (
    <div className="grid grid-rows-[1fr_1fr_1fr_1fr_1fr_6fr] min-w-12 bg-stone-900 border-r border-TradeSharegray">
      <Link to="/">
        <button
          value="Home"
          className={selected === "Home" ? selectedClass : defaultClass}
          onClick={(e) => {
      ...
      <Link to="/MyAccounts">
        <button
          value="MyAccounts"
          className={selected === "MyAccounts" ? selectedClass : defaultClass}
          onClick={(e) => {
            setSelected(e.currentTarget.value);
          }}
        >
      ...
      <Link to="/LinkAccount">
        <button
          value="LinkAccount"
          className={selected === "LinkAccount" ? selectedClass : defaultClass}
          onClick={(e) => {
            setSelected(e.currentTarget.value);
          }}
        >
      ...
      <Link to="/Inbox">
        <button
          value="Inbox"
          className={selected === "Inbox" ? selectedClass : defaultClass}
          onClick={(e) => {
            setSelected(e.currentTarget.value);
          }}
        >
      ...
      <Link to="/Following">
        <button
          value="Following"
          className={selected === "Following" ? selectedClass : defaultClass}
          onClick={(e) => {
            setSelected(e.currentTarget.value);
          }}
        >
