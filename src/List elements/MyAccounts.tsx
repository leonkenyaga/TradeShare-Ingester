...
<svg className="flex-shrink-0 w-5 h-10 text-gray-500 transition duration-75 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
...
<BasePopup id={id} open={open} anchor={anchor} placement={placement} offset={4}>
   <div className='bg-stone-900 p-2 border-2 rounded-xl border-TradeSharegray'> MyAccounts </div>
 </BasePopup>
    </div>
